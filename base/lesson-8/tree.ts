...
// const config = createNode(tree.root);

// const root = document.querySelector(".root");

// function renderNode(key: string, index?: number) {
...
// function renderTree(config: { key: string; children: [] }, index?: number) {
//   const stack = [];

//   stack.push(config.children);

//   root?.append(renderNode(config.key));
